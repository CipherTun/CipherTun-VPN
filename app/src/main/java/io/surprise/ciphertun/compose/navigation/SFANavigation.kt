...
import io.surprise.ciphertun.compose.wizard.ProtocolFormScreen
import io.surprise.ciphertun.compose.wizard.ProtocolPickerScreen
    ...
    NavHost(
        ...
        composable(ProfileRoutes.NewProfile) {
            ...
            NewProfileScreen(
                ...
                onOpenWizard = {
                    navController.navigate(ProfileRoutes.Wizard)
                },
            )
        }

        composable(ProfileRoutes.Wizard) {
            ProtocolPickerScreen(
                onProtocolSelected = { protocol ->
                    navController.navigate(ProfileRoutes.wizardForm(protocol.name))
                },
        ...
        composable(
            route = ProfileRoutes.WizardForm,
            arguments = listOf(
            ...
            val protocolName = entry.arguments?.getString("protocol")
